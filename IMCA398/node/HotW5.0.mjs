...
function T2IprintImage() {
    ...
    io.emit("S2CData", "T2I | PRINTING IMAGE...")
...
async function I2TcaptureImage() {
    ...
    io.emit("S2CData", "I2T | CAPTURING IMAGE...")
...
function I2TprintText(text) {
    ...
    io.emit("S2CData", "I2T | PRINTING TEXT...")
...
async function T2ScaptureText() {
    ...
    io.emit("S2CData", "T2S | CAPTURING TEXT...")
...
function T2SsaveText(text) {
    ...
    io.emit("S2CData", "T2S | FETCHING TEXT...")
