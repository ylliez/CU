...
let filepath = `HotW_test/${timestamp}/`, fileiter = `${filepath}${iter}`;
...
// doTheThing();
// T2IgetImage('https://replicate.delivery/pbxt/CMpVM8ep4cxtTS0DQmEBheBP6rabIAFCFibOAkOan2XEIyyQA/out-0.png')
// I2T();
// T2S();
// T2SpredictSpeech("a poom with a |cture bangiiy uthe wall, a malte painting by R-ichard & a Wa");
// T2SsaveText("da Fuom with a pjClure Hanging onthe wall, a matle painting by Richard Benning,behance, fluvus,latte painting,Construct ivisii,latte drawing");
// T2S();
