...
let filepath = `HotW_test/${timestamp}/`, fileiter = `${filepath}${iter}`, filestep = `${fileiter}_${step}`;
...
board.on("ready", function () {
    ...
    setTimeout(function () { incrementStepAndTurnLedOn(); }, 2500);
});
