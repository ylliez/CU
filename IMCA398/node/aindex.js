// function btnStartOn() {
//     console.log("ping")
//     document.getElementById('btnStart').innerHTML = "hi"
// }
...
io.on("connection", (socket) => {
    ...
    socket.on("buttonPress", () => {
        console.log("Button pressed on client");
        // Emit an event to trigger an action on the server
        io.emit("serverAction", "Server action triggered");
    });
