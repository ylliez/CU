...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 668.0, 528.0, 114.0 ],
					"text" : "FM synth:\n the frequencies of the sidebands are determined by the relationship between the carrier frequency (Fc) and the modulator frequency (Fm) --> harmonicity ratio (Fm/Fc)\nthe relative strength of the different sidebands (which affects the timbre) is determined by the relationship between the modulator amplitude (Am) and the modulator frequency (Fm) --> modulation index (Am/Fm)\n\nSideband frequencies present: Fc, Fc+Fm, Fc-Fm, Fc+2Fm, Fc-2Fm, Fc+3Fm, Fc-3Fm, etc."
				}
